...
def main(config):
    ...
    train_loader = torch.utils.data.DataLoader(train_dataset, batch_size = 4, shuffle = True, num_workers = config.num_workers)
    valid_loader = torch.utils.data.DataLoader(val_dataset, batch_size = 2, num_workers = config.num_workers)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_max_epoch', type=int, default=2000)
    ...
    # early stop mechanism
    parser.add_argument('--epoch_patience', type=int, default=2000)
