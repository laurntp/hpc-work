...
def getHeart(landmarks):
    leftlung = reverseVector(landmarks.reshape(-1))
...
class ToTensorSegLH(object):
    ...
    def __call__(self, sample):
        ...
        landmarks = np.clip(landmarks, 0, 1)[:15]
    ...
    for epoch in range(config['epochs']):
        ...
        with torch.no_grad():
            for sample_batched in val_loader:                
                ...
                dcl = evalImageMetrics(seg, target[0,:,:])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", default = "name_cephalo_unet", type=str)
    ...
    if config['extended']:
        ...
        train_path = "Datasets/Cytomine/Droso/Train"
        val_path = "Datasets/Cytomine/Droso/Val" 
